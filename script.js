...
function buttonClick(button){
    ...
    <div class="result mb-5">
        ...
        <div class="d-flex justify-content-between">
            <button type="button" class="btn btn-outline-secondary  game-choice">${computerSymbol}</button>
            <button type="button" class="btn btn-outline-secondary  game-choice">${userSymbol}</button>
        </div>
        <button type="button" id="continuer" onclick="buttonContinuer()" class="btn btn-outline-secondary ">Rejouer</button>
    </div>`;
    updateScore();
}
